...
class UpdateNavigationController: UINavigationController {
...
extension UpdateNavigationController: UINavigationControllerDelegate {
    ...
    -> UIViewControllerAnimatedTransitioning? {
        if operation == .push { self.interactiveTransition.viewController = toVC
